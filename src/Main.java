...
public class Main {
    private static final double[] interval = new double[]{-5.0, 5.0};

    public static double function1(double x) {
        return x * Math.cos(5 + x);
    }
    ...
    public static void main(String[] args) {
        ...
        {
            double[] solve15 = solveWithEquallySpacedNodes(3, 1);
            System.out.println("Коэффициенты многочлена степени 3 для первой функции: ");
            System.out.println(Arrays.toString(solve15));

            double[] solve110 = solveWithEquallySpacedNodes(10, 1);
            System.out.println("Коэффициенты многочлена степени 10 для первой функции: ");
            System.out.println(Arrays.toString(solve110));


            double[] solve120 = solveWithEquallySpacedNodes(20, 1);
            System.out.println("Коэффициенты многочлена степени 20 для первой функции: ");
            System.out.println(Arrays.toString(solve120));
            System.out.println();

            double accuracy15 = getAccuracy(solve15, 1);
            System.out.println("Погрешность многочлена степени 3 для первой функции: ");
            System.out.println(accuracy15);

            double accuracy110 = getAccuracy(solve110, 1);
            System.out.println("Погрешность многочлена степени 10 для первой функции: ");
            System.out.println(accuracy110);

            double accuracy120 = getAccuracy(solve120, 1);
            System.out.println("Погрешность многочлена степени 20 для первой функции: ");
            System.out.println(accuracy120);
            System.out.println();

            double[] solve25 = solveWithEquallySpacedNodes(3, 2);
            System.out.println("Коэффициенты многочлена степени 3 для второй функции: ");
            System.out.println(Arrays.toString(solve25));

            double[] solve210 = solveWithEquallySpacedNodes(10, 2);
            System.out.println("Коэффициенты многочлена степени 10 для второй функции: ");
            System.out.println(Arrays.toString(solve210));


            double[] solve220 = solveWithEquallySpacedNodes(20, 2);
            System.out.println("Коэффициенты многочлена степени 20 для второй функции: ");
            System.out.println(Arrays.toString(solve220));

            double accuracy25 = getAccuracy(solve25, 2);
            System.out.println("Погрешность многочлена степени 3 для второй функции: ");
            System.out.println(accuracy25);

            double accuracy210 = getAccuracy(solve210, 2);
            System.out.println("Погрешность многочлена степени 10 для второй функции: ");
            System.out.println(accuracy210);


            double accuracy220 = getAccuracy(solve220, 2);
            System.out.println("Погрешность многочлена степени 20 для второй функции: ");
        ...
        {
            double[] solve15 = solveWithChebushevNodes(3, 1);
            System.out.println("Коэффициенты многочлена степени 3 для первой функции по чебышёвским узлам: ");
            System.out.println(Arrays.toString(solve15));

            double[] solve110 = solveWithChebushevNodes(10, 1);
            System.out.println("Коэффициенты многочлена степени 10 для первой функции по чебышёвским узлам: ");
            System.out.println(Arrays.toString(solve110));

            double[] solve120 = solveWithChebushevNodes(20, 1);
            System.out.println("Коэффициенты многочлена степени 20 для первой функции по чебышёвским узлам: ");
            System.out.println(Arrays.toString(solve120));
            ...
            double[] solve25 = solveWithChebushevNodes(3, 2);
            System.out.println("Коэффициенты многочлена степени 3 для второй функции по чебышёвским узлам: ");
            System.out.println(Arrays.toString(solve25));

            double[] solve210 = solveWithChebushevNodes(10, 2);
            System.out.println("Коэффициенты многочлена степени 10 для второй функции по чебышёвским узлам: ");
            System.out.println(Arrays.toString(solve210));


            double[] solve220 = solveWithChebushevNodes(20, 2);
            System.out.println("Коэффициенты многочлена степени 20 для второй функции по чебышёвским узлам: ");
            System.out.println(Arrays.toString(solve220));
